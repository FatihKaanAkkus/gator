...
SELECT feeds.id, feeds.created_at, feeds.updated_at, feeds.name, feeds.url, feeds.user_id, users.name as username FROM feeds LEFT JOIN users ON feeds.user_id = users.id
`
